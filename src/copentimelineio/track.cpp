...
OTIO_API TimeRange* Track_trimmed_range_of_child(
    Track* self, Composable* child, OTIOErrorStatus* error_status)
{
    return Composition_trimmed_range_of_child(
        (Composition*) self, child, error_status);
}
OTIO_API TimeRange* Track_trim_child_range(Track* self, TimeRange* child_range)
{
...
OTIO_API TimeRange* Track_source_range(Track* self)
{
