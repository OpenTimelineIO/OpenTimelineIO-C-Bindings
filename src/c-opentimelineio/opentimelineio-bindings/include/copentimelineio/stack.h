...
OTIO_API TimeRange* Stack_range_of_child(
    Stack* self, Composable* child, OTIOErrorStatus* error_status);
OTIO_API TimeRange* Stack_trimmed_range_of_child(
    Stack* self, Composable* child, OTIOErrorStatus* error_status);
OTIO_API TimeRange* Stack_trim_child_range(Stack* self, TimeRange* child_range);
...
OTIO_API TimeRange* Stack_source_range(Stack* self);
